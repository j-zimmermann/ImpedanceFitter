...
copyright = """2018, 2019, Leonard Thiele, leonard.thiele[AT]uni-rostock.de,
               2018 - 2024, Julius Zimmermann, julius.zimmermann[AT]uni-rostock.de"""
...
version = importlib.metadata.version("impedancefitter")
...
man_pages = [
    (master_doc, "impedancefitter", "ImpedanceFitter Documentation", [author], 1)
]
