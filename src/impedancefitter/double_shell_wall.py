...
def eps_cell_double_shell_wall(
...
def double_shell_wall_model(
    ...
    epsi_cell = eps_cell_double_shell_wall(
        omega, km, em, kcp, ecp, kne, ene, knp, enp, kw, ew, dm, Rc, dn, Rn, dw
    )
...
def double_shell_wall_bh_model(
    omega,
    km,
    em,
    kcp,
