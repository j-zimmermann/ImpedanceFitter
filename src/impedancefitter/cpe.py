...
def cpe_onset_model(omega, f0, nu, Z0):
    ...
    References
    ----------
    .. [Ishai2012] Ishai, P. Ben, Sobol, Z., Nickels, J. D., Agapov, A. L.,
                   & Sokolov, A. P. (2012).
                   An assessment of comparative methods for approaching electrode
                   polarization in dielectric permittivity measurements.
                   Review of Scientific Instruments, 83(8).
                   https://doi.org/10.1063/1.4746992
    """
    Z_fit = Z0 * np.power(1j * omega / (2.0 * np.pi * f0), -nu)
    return Z_fit
